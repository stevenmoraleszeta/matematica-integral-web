...
5) Formularios (tiempo).
    ...
    //DO El campo activo no muestra opciones
    //DO Lo botones de acciones deben tener hover y estar alineados a la izquierda
    ...
    //DO Fix answer forms web platform error
